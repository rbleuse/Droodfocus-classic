...
local frames = {
	{ frame=nil, overlay=nil, overlayTexture=nil, position={0,0}, alpha=1, state=0, height=256, pas=0.005 },
	{ frame=nil, overlay=nil, overlayTexture=nil, position={0,0}, alpha=1, state=0, height=256, pas=0.005 },
	{ frame=nil, overlay=nil, overlayTexture=nil, position={0,0}, alpha=1, state=0, height=256, pas=0.005 },
	{ frame=nil, overlay=nil, overlayTexture=nil, position={0,0}, alpha=1, state=0, height=256, pas=0.005 },
	{ frame=nil, overlay=nil, overlayTexture=nil, position={0,0}, alpha=1, state=0, height=256, pas=0.005 },
...
function DF:init_blood_frame()
	for i = 1,5 do
		if not frames[i].frame then
			...
			-- overlay
			frames[i].overlay = CreateFrame("FRAME", "DF_BLOOD_FRAME"..tostring(i), frames[i].frame)
			-- la texture
