...
DF.help ={
	...
	["gps"]="G.P.S.|Shows the direction where is located the raid/group member targeted.|Only works for players of your raid/group.|This feature is still being tested and may sometimes not work in certain areas.",
...
if (GetLocale() == "frFR") then
	...
	DF.help ={
		...
		["gps"]="G.P.S|Montre la direction ou se trouve le membre du raid/groupe ciblé.|Fonctionne uniquement pour les joueurs de votre raid/groupe.|Cette fonction est encore en phase de test et peut parfois ne pas fonctionner dans certaines zones.",
